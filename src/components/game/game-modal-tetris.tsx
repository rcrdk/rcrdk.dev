					...
					<div className="hidden sm:block">
						<div className="mb-6 flex items-center justify-between">
							<div className="flex items-center gap-2">
								...
								<div>
									<DialogRadix.Title className="mb-1 flex items-center gap-2 font-mono text-2xl leading-none font-black tracking-tighter text-black dark:text-white">
										{__('game.tetris.title')}
									</DialogRadix.Title>

									<DialogRadix.Description className="sr-only">{__('game.tetris.title')}</DialogRadix.Description>
									...
									<div className="dark:bg-dropdown-dark flex w-9/12 flex-col items-center justify-center rounded-xl border border-black/20 bg-white p-6 text-center shadow-2xl dark:border-white/20">
										{state === 'LOST' && (
											<>
												...
												<Button variant="solid" size="sm" className="font-medium" onClick={() => controller.restart()}>
