...
const baseVariants = cva(
	...
	),
	{
		variants: {
			...
			size: {
				base: 'xs:gap-4 xs:px-5 h-12 gap-3 px-5',
				lg: 'xs:h-14 xs:gap-5 xs:px-6 h-12 gap-4 px-6',
				sm: 'xs:h-10 xs:px-4 h-10 gap-2 px-2',
				xs: 'xs:h-8 xs:ap-4 xs:px-5 h-8 gap-4 px-4',
			},
			icon: {
				true: {},
				false: {},
