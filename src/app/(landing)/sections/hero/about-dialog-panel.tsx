...
interface HeroAboutDialogPanelProps {
	open: boolean
	onOpenChange: (open: boolean) => void
}

export function HeroAboutDialogPanel({ open, onOpenChange }: Readonly<HeroAboutDialogPanelProps>) {
	...
	return (
		<AboutDialogWrapper open={open} onOpenChange={onOpenChange} aria-describedby={undefined}>
