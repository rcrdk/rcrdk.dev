		...
		<>
			<div className="flex flex-col gap-4 sm:flex-row">
				<div className="flex grow gap-4">
					<div className="squircle-rounded layout:size-13 layout-xl:size-15 relative size-15 shrink-0 self-start overflow-hidden rounded-2xl shadow">
			...
			<ul className="layout-xl:text-base layout:text-[0.9375rem] layout-sm:text-base layout:pt-4 layout-sm:pt-6 layout-xl:space-y-1.5 hidden list-disc space-y-1.5 pt-6 pl-4 text-pretty sm:block sm:space-y-0">
				{data.description.map((description) => (
					<li key={description} dangerouslySetInnerHTML={{ __html: description }} />
				))}
			</ul>
